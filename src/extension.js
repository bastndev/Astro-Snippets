...
function activate(context) {
  console.log(
    'Congratulations, your extension "astro-js-snippets" is now active!'
  );
  ...
  vscode.window
    ...
    .then((selected) => {
      ...
      if (selected.isCreateNew) {
        vscode.commands.executeCommand("astro-snippets.createSnippet");
        return;
      }
...
function createActionItems(file) {
  const actions = [
    {
      ...
      command: "astro-snippets.openSnippet",
      args: [file.path],
    },
    {
      label: "🔄 Refresh Snippets",
      description: "Reload snippets in VS Code",
      command: "astro-snippets.refreshSnippets",
      args: [],
    },
  ];
  ...
  if (file.hasOriginal) {
    actions.push({
      ...
      command: "astro-snippets.resetSnippet",
  ...
  if (!file.hasOriginal) {
    actions.push({
      ...
      command: "astro-snippets.deleteSnippet",
      args: [file.path],
    });
  }
 ...
 */
function deactivate() {
  console.log("Astro Snippets extension deactivated");
}
// ============================================================================
